...
[![Version](https://img.shields.io/badge/version-5.2.5-violet?style=flat-square)](https://github.com/zhaoxinyi02/ClawPanel/releases)
...
> [!NOTE]
> **v5.2.5 Update** — Windows environment detection is now more resilient: Git / Python / npm common install paths are included, fallback commands are expanded, and OpenClaw install checks now verify `node + npm + git` usability before proceeding. See [changelogs/v5.2.5.md](changelogs/v5.2.5.md)
