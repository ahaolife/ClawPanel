...
> [!NOTE]
> **v5.0.3 New** — 🧩 Plugin Center (browse/install/configure/update plugins), Windows NapCat native install (no Docker needed), full Windows PowerShell support for all install scripts, cross-platform fixes. [View changelog](changelogs/v5.0.3.md)
