...
[![Lite](https://img.shields.io/badge/Lite-0.1.1-2563eb?style=flat-square)](https://github.com/zhaoxinyi02/ClawPanel/releases)
...
> [!NOTE]
> **最新 Pro / Lite 更新** — `ClawPanel Pro v5.2.7` 重点补强 QQ (NapCat) 通道删除、一键安装和插件镜像回退；`ClawPanel Lite v0.1.1` 继续收口开箱即用体验，安装后只需配置 API Key 和通道凭据即可直接使用。详见 [changelogs/v5.2.7.md](changelogs/v5.2.7.md) 和 [changelogs/lite-v0.1.1.md](changelogs/lite-v0.1.1.md)
...
- `Release Build`（`.github/workflows/release.yml`）
  - 触发：`push tag lite-v* / pro-v*`（如 `lite-v0.1.1`、`pro-v5.2.7`）/ 手动触发
