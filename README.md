...
[![Lite](https://img.shields.io/badge/Lite-0.1.3-2563eb?style=flat-square)](https://github.com/zhaoxinyi02/ClawPanel/releases)
...
> [!NOTE]
> **最新 Pro / Lite 更新** — `ClawPanel Pro v5.2.7` 重点补强 QQ (NapCat) 通道删除、一键安装和插件镜像回退；`ClawPanel Lite v0.1.3` 修复面板更新页跳转不可用、继续收口模型服务商和开箱即用体验。详见 [changelogs/v5.2.7.md](changelogs/v5.2.7.md) 和 [changelogs/lite-v0.1.3.md](changelogs/lite-v0.1.3.md)
